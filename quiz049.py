...
query = """SELECT * FROM ledger join users on ledger.sender_id = users.id WHERE users.name = 'bob6'"""
query2 = """SELECT * FROM ledger join users on ledger.receiver_id = users.id WHERE users.name = 'bob6'"""
